										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="subcategory" placeholder="Enter subcategory Name"
													class="span8 tip" value="<?php echo $row['subcatname']; ?>" readonly required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="productCompany"
													...
													placeholder="Enter Product Comapny Name" class="span8 tip" readonly required>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Kg and Nos <span>*</span></label>
											<div class="controls">
												<input type="text"
													onkeypress="return event.charCode >= 48 && event.charCode <= 57"
													name="prodAvail" placeholder="Enter Kg and Nos"
													value="<?php echo htmlentities($row['prod_avail']); ?>"
