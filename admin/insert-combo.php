                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" name="insertcombo" method="post"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text"
                                                ...
                                                name="combopricebd" placeholder="Enter Combo Price" class="span8 tip"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="comboDescription" placeholder="Enter Combo Description" rows="6"
                                                class="span8 tip">
                </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <table id="tblProd" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tbody id="tblBody">
                                            <tr>
                                                ...
                                                <td><input type="text"
                                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                        name="quantity[]" placeholder="Enter Quantity" class="span8 tip"
                                                        required></td>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">Combo Image1
                                            <span>*</span></label>
                                        <div class="controls">
                                            <input type="file" name="comboimage1" id="comboimage1" value="" accept="image/*"
                                                class="span8 tip" required>
                                        </div>
                                    </div>
