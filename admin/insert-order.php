                                ...
                                <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" name="insertproduct" method="post"
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="table"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="datetime-local" required name="dateTime"
                                                            placeholder="Choose date and time" class="span8 tip" step="any"
                                                            min="<?= date('Y-m-d', strtotime('tomorrow')) . "T" . date('H:i:s'); ?>">
                                                    </td>
                                                    <td><input type="text" name="remarks" placeholder="Enter remarks if any"
                                                            class="span8 tip"></td>
                                                    <td>
                                                        <div style="font-weight: bold;">Total Amount ₹<span
                                                                id="totAmt">0.00</span>*</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <button type="submit" style="float:right" name="submit" class="btn btn-ri">Add
                                            Order</button>
                                    </form>
                                </div>
                            </div>
