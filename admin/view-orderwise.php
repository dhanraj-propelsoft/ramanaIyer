									...
									<form class="form-horizontal row-fluid" name="vieworder" method="post"
                                        ...
                                        style="width:100%;padding:5px;">
                                            ...
                                            <tbody id="tblBody">
                                                ...
                                                <tr>
                                                    <td><?=$rw['cnt']?></td>
                                                    <td><label style="font-weight: bold;"><?=$rw['iName']; ?></label></td>
                                                    <td><label style="font-weight: bold;"><?=$rw['iPrice']; ?></label></td>
                                                    <td><label style="font-weight: bold;"><?=$rw['iQty']; ?></label></td>
                                                    <td><label style="font-weight: bold;"><?=$rw['amount']; ?></label></td>
                                                </tr>                                                
                                                <?php } ?>
                                            </tbody>
                                        </table>
