        ...
        <div class="checkout-box faq-page inner-bottom-sm">
            <div class="row" id="Privacy">
                <div class="col-md-12">
                    ...
                    <p>This privacy policy sets out how RAMANA EXPORTS & WHOLESALE uses and protects any information
                        that you give RAMANA EXPORTS & WHOLESALE when you use this website.
                    </p>
                    <p>RAMANA EXPORTS & WHOLESALE is committed to ensuring that your privacy is protected. Should we ask
                        you to provide certain information by which you can be identified when using this website, and
                        then you can be assured that it will only be used in accordance with this privacy statement.
                    </p>
                    <p>RAMANA EXPORTS & WHOLESALE may change this policy from time to time by updating this page. You
                        should check this page from time to time to ensure that you are happy with any changes.
                    </p>
                    <p><b>We may collect the following information:</b>
                    <ul>
                        <li>
                            Name and job title
                        </li>
                    ...
                    <p><b>What we do with the information we gather</b>
                    </p>
                    ...
                    <p>A cookie is a small file which asks permission to be placed on your computer's hard drive. Once
                        you agree, the file is added and the cookie helps analyses web traffic or lets you know when you
                    ...
                    <p>We use traffic log cookies to identify which pages are being used. This helps us analyses data
            ...
            <div class="row" id="Terms">
                <div class="col-md-12">
                    ...
                    <p>The Website Owner, including subsidiaries and affiliates (“Website” or “Website Owner” or “we” or
                        “us” or “our”) provides the information contained on the website or any of the pages comprising
                        the website (“website”) to visitors (“visitors”) (cumulatively referred to as “you” or “your”
                        hereinafter) subject to the terms and conditions set out in these website terms and conditions,
                        the privacy policy and any other relevant terms and conditions, policies and notices which may
                        be applicable to a specific section or module of the website.</p>
                    ...
                    <p>Welcome to our website. If you continue to browse and use this website you are agreeing to comply
                        ...
                        policy govern RAMANA EXPORTS & WHOLESALE''s relationship with you in relation to this website.
                    </p>

                    <p>The term 'RAMANA EXPORTS & WHOLESALE' or 'us' or 'we' refers to the owner of the website whose
                        registered/operational office is 4/1026, West Agraharam, Biksandarkovil, No1 Tolgate,
                        Tiruchirappalli TAMIL NADU 621216. The term 'you' refers to the user or viewer of our website.
                    </p>

                    <p><b>The use of this website is subject to the following terms of use:</b>
                    <ul>
                        <li>
                        ...
                        <li>
                            You may not create a link to this website from another website or document without RAMANA
                            EXPORTS & WHOLESALE’s prior written consent.
                        </li>
                        <li>
                    ...
                    <p>We as a merchant shall be under no liability whatsoever in respect of any loss or damage arising
                        directly or indirectly out of the decline of authorization for any Transaction, on Account of
                        the Cardholder having exceeded the preset limit mutually agreed by us with our acquiring bank
                        from time to time</p>
                </div>
            </div><!-- /.row -->
            ...
            <div class="row" id="Contact">
                <div class="col-md-12">
                    ...
                    <p>
                        ...
                        Merchant Legal entity name: RAMANA EXPORTS & WHOLESALE<br>
                        Registered Address: 4/1026, West Agraharam, Biksandarkovil, No1 Tolgate, Tiruchirappalli TAMIL
                        NADU 621216<br>
                        Operational Address: 4/1026, West Agraharam, Biksandarkovil, No1 Tolgate, Tiruchirappalli TAMIL
                        NADU 621216<br>
                        Telephone No: 9655 10 5555<br>
                        E-Mail ID: ramanaexp@gmail.com
                    </p>
                </div>
            </div><!-- /.row -->
        </div><!-- /.checkout-box -->
